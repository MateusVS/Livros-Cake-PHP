 ...
 * @method \App\Model\Entity\Livrosgenero saveOrFail(\Cake\Datasource\EntityInterface $entity, $options = [])
...
class LivrosgenerosTable extends Table
{
    ...
    public function buildRules(RulesChecker $rules)
    {
        ...
        $rules->add($rules->existsIn(['generos_id'], 'Generos'));
