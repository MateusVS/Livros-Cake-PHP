...
class LivrosFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'titulo' => ['type' => 'string', 'length' => 50, 'null' => false, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        ...
        '_constraints' => [
            ...
            'livros_ibfk_1' => ['type' => 'foreign', 'columns' => ['autor_id'], 'references' => ['autores', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'quantidade' => 1,
                'isbn' => 1,
                'created' => '2019-05-29 12:29:17',
                'modified' => '2019-05-29 12:29:17',
                'autor_id' => 1
            ],
        ];
        parent::init();
